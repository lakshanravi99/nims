...
<div class="content">
               ...
               <div class="intro-y box mt-5" method="post" action="{{ route('users.store')}}">
               @csrf
                            ...
                            <div id="horizontal-form" class="p-3">
                                <div class="preview">
                                    ...
                                    <div class="form-inline">
                                        <label for="horizontal-form-1" class="form-label sm:w-20">Emp. ID</label>
                                        <input id="empid" name="empid" type="text" class="form-control" placeholder="NA001">
                                    </div>

                                    <div class="form-inline mt-5">
                                        <label for="horizontal-form-2" class="form-label sm:w-20">User Name</label>
                                        <input id="username" name="username" type="text" class="form-control" placeholder="kasun">
                                    </div>

                                     <div class="form-inline mt-5">
                                        <label for="horizontal-form-2" class="form-label sm:w-20">Password</label>
                                        <input id="password" name="password"  type="password" class="form-control" placeholder="secret">
                                    </div>

                                     <div class="form-inline mt-5">
                                      <label for="horizontal-form-2" class="form-label sm:w-20">User Type</label>
                                      ...
                                      <div class="form-inline mt-5">
                                      <label for="horizontal-form-2" class="form-label sm:w-20">Place</label>
                                       <select name="place" id="place" class="form-select mt-2 sm:mr-2" aria-label="Default select example">
                                                 <option>IT</option>
                                    ...
                                    <div class="sm:ml-20 sm:pl-5 mt-5">
                                       <input type="submit" class="btn btn-primary btn-rounded mb-5" value="Submit">
                                    </div>
                                </div>
