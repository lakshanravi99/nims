...
<div class="content">
                ...
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    ...
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                        <a href="{{route('users.add')}}" class="btn btn-primary shadow-md mr-2" > Add Attendance</a>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                        <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
                            <div class="sm:flex items-center sm:mr-4">
                                <label class="w-12 flex-none xl:w-auto xl:flex-initial mr-2">Department/Branch</label>
                                <select id="tabulator-html-filter-field" class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                                    <option selected>Select</option>
                                   
                                   @if(count($allData))
                                        @foreach ( $allData as $key=> $user)
                                             <option value="{{$user->employees->place}}">{{$user->employees->place}}</option>

                                        @endforeach

                                   @endif

                                    {{-- <option value="name">Exam</option>
                                    <option value="category">Branch 01</option>
                                    <option value="remaining_stock">IT</option> --}}
                                </select>
                            </div>

                            <div class="sm:flex items-center sm:mr-4">
                                <label class="w-12 flex-none xl:w-auto xl:flex-initial mr-2">Monthly</label>
                                <select id="tabulator-html-filter-field" class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                                    <option value="name">This Month</option>
                                    <option value="category">Last Month</option>
                                    <option value="remaining_stock">Last 06 Month</option>
                                </select>
                            </div>
